        ...
        {/* <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#benefits" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Avantages
                </a>
              </li>
              <li>
                <a href="#process" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Processus
                </a>
              </li>
              <li>
                <a href="#pricing-calculator" className="text-gray-300 hover:text-accent transition-colors duration-300">
                  Calculateur
                </a>
              </li>
              <li>
